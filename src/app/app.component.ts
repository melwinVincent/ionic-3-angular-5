...
export class MyApp {
  ...
  */
  ...
  constructor(
    ...
    if(this.cacheMemoryService.get('sessionID')) {
      this.rootPage = (this.cacheMemoryService.getJSON('loginResponse') && this.cacheMemoryService.getJSON('loginResponse').username) ? 'HomePage' : 'LoginPage'; 
    } else {
    ...
    */
    ...
    events.subscribe('page:push', (page) => {
      // open the page
      this.openPage(page);
    });
