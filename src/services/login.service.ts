...
export class LoginService {
    ...
    // Observable for posting  login
    loginObservable : Observable<any>

    // Observable for posting register
    ...
    constructor(
        ...
        this.loginObservable = Observable.create(observer => {
            ...
            */
            this.presentLoading();
            this.memoryService.updatePostObservers('loginObservable', true);
            ...
            this.http.post(APP_CONFIG.baseUrl+'Register/SigninRequest', this.postData, {headers: this.headersInstance}).subscribe(data => {
                // to remove the refernce string from memory
                this.memoryService.updatePostObservers('loginObservable', false);
        ...
        // observable for POST api
        this.registerObservable = Observable.create(observer => {
            ...
            */
            this.presentLoading();
            this.memoryService.updatePostObservers('registerObservable', true);
            // before calling the POST api, this.postData is set by calling the setPostData method of this same service from the component
            this.http.post(APP_CONFIG.baseUrl+'Register/SignupRequest', this.postData, {headers: this.headersInstance}).subscribe(data => {
                // to remove the refernce string from memory
                this.memoryService.updatePostObservers('registerObservable', false);
                this.loading.dismiss();
                // call next method and pass data to the component
                observer.next(data);
                observer.complete();
